...
class DetailsPost extends StatefulWidget {
  ...
  DetailsPost({@required this.ciemaModel});
...
class _DetailsPostState extends State<DetailsPost> {
                ...
                Center(
                  child: FlatButton(
                    onPressed: () => Get.to(
                      (() => Pay(
                        hour: hours,
                        idEvent: widget.ciemaModel.id,
                        nameEvent: widget.ciemaModel.name,
                        min: min,
  ...
  Widget ticketWidget(BuildContext context) {
    return Container(
